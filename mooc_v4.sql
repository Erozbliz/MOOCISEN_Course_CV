...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 02 Février 2016 à 11:22
...
(1, 2, 100, 1, NULL, 1, 200, 1),
(2, 3, 200, 1, 1, NULL, 200, 1);
...
INSERT INTO `mooc` (`id_mooc`, `nom`, `description`, `prerequis`, `duree`, `note`, `nb_chap`) VALUES
(1, 'CV Ingénieur ISEN', 'Ce MOOC vous permettra de connaitre les codes pour la réalisation d''un CV pour un ingénieur, et plus particulièrement un ingénieur informatique.\n\n', 'Aucun', 35, 4, 7),
(2, 'Physique des solides', 'Ce cours portera sur la physique des solides ', 'Aucun', 20, 5, 5),
(3, 'Initiation au SHELL', 'Ce cours vous permettra d''acquérir les bases du langage SHELL', 'Aucun', 20, 4, 6);
...
(1, 'Perrichon est il beau ?', 'oui ', 'oui ', 'Oui ', 1);
...
INSERT INTO `user` (`id_user`, `nom`, `prenom`, `pseudo`, `email`, `password`, `ville`, `grade`) VALUES
(1, '5', '6', '5', '5', '5', '5', 5),
(2, 'sdfsd', 'dsfsdf', 'sdfsdfsd', 'olivier.colombies@gmail.c', 'ab4f63f9ac65152575886860d', 'BS', 1),
(3, 'Colombies', 'zdc', 'dssd', 'olivier.colombies@gmail.c', 'ab4f63f9ac65152575886860d', 'AF', 1),
(4, '', '', '', '', 'd41d8cd98f00b204e9800998e', '', 1),
(5, 'Colombies', 'Olivier', 'dsfsdfsdf', 'olivier.colombies@gmail.c', 'ab4f63f9ac65152575886860d', 'CW', 1),
(6, '', '', '', '', 'd41d8cd98f00b204e9800998e', '', 1),
(7, '', '', '', '', 'd41d8cd98f00b204e9800998e', '', 1),
(8, 'sdfsdf', 'sdgfsdfssdf', 'sdfsdfsdf', 'olivier.colombies@gmail.c', 'ab4f63f9ac65152575886860d', 'SE', 1),
(9, '', '', '', '', 'd41d8cd98f00b204e9800998e', '', 1),
(10, '', '', '', '', 'd41d8cd98f00b204e9800998e', '', 1);
